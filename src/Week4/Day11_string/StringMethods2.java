...
public class StringMethods2 {
    public static void main(String[] args) {
        ...
        sentence2 = sentence2.replaceFirst("Python", "Java");
        System.out.println(sentence2);
        ...
        int begining = email.indexOf('@')+1;
        int ending = email.lastIndexOf('.');
        String domain = email.substring(begining,ending);
        ...
        String r2 = sentence7.substring(sentence7.lastIndexOf(" ")+ 1);
